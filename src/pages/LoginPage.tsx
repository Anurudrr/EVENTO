...
const LoginPage: React.FC = () => {
  ...
  const { login, sendOtp, verifyOtp, googleAuth, isLoading, error } = useAuth();
  ...
  const handlePasswordSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('[login:password-submit]', err);
    }
  };
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      setOtpSent(true);
      setStatusMessage('A login code has been sent to your email.');
